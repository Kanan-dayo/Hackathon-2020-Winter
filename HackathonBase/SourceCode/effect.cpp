...
// コンストラクタ
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CEffect::CEffect() :CScene(CScene::PRIORITY::PRIORITY_2DEFFECT)
{
}
...
)
{
	...
	{
		pEffect->pos				= ML_VEC3_UNSET;					// 位置
		pEffect->rot				= ML_VEC3_UNSET;					// 回転量
		pEffect->move				= ML_VEC3_UNSET;					// 移動量
		pEffect->col				= ML_D3DXCOR_SET;					// 色
		pEffect->size				= ML_VEC2_UNSET;					// サイズ
		pEffect->sizeValue			= ML_VEC2_UNSET;					// 半径の変化値
